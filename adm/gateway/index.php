    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            <div class="card" style="margin-bottom: 100px;">
                ...
                <h2 style="margin-left: 25px;">Configuração Mangofy</h2>
                    <style>
                        #card-title {
                            font-size: 25px;
                        }
                    ...
                    <div class="card-container" style="display: flex; flex-wrap: wrap;">
                        <form id="gateway-form">
                            <div class="card-id" id="card-gateway">
                                <p id="card-title"><strong>Authorization Token (Mangofy)</strong></p>
                                <input id="input-id" class="input-id" name="clientID" type="text"
                                    placeholder="Token de autorização Mangofy" value="<?php echo htmlspecialchars($client_id); ?>">
                            </div>
                            <div class="card-secret" id="card-gateway-secret">
                                <p id="card-title"><strong>Store Code (Mangofy)</strong></p>
                                <input id="input-secret" class="input-secret" name="clientSecret" type="text"
                                    placeholder="Store Code Mangofy" value="<?php echo htmlspecialchars($client_secret); ?>">
                            </div>
                            <div class="button-container">
                                <button type="submit" id="gateway-btn">Salvar Configuração</button>
                            </div>
                        </form>
                    </div>
            </div>
